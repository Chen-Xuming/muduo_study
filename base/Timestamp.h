 ...
 *
 *      两种格式：
 *      1. 精度为秒：    yyyymmdd hhmmss
 *      2. 精度为微秒    yyyymmdd hhmmss.xxxxxx   xxxxxx是微秒
 *
 */
...
namespace muduo {
    ...
    private:
        int64_t microSecondsSinceEpoch_;        // 从1970年01月01日00时00分00至今的毫秒数
    };
